...
// rpc
export const AVAX_HOST = config.testnetExtra.testLocalRpcSrc;
export const ETH_HOST = config.testnetExtra.testLocalRpcDest;

// forks
export const FORK_AVAX_CHAIN_ID = Number(
  config.chainConfigs.Avalanche.chainId!
);
